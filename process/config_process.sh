...
#declare -a Nperiods=(120 240 360 480 600 720 1200 2400 4800)
#declare -a Nstorages=(10 30 50)

declare -a Nperiods=(1)
declare -a Nstorages=(0) #for OPF, Nstorages is ignored but make it length 1
